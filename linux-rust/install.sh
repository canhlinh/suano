...
cp "$ICON_SRC/16.png"  "$ICON_DIR/16x16/apps/suano.png"
cp "$ICON_SRC/32.png"  "$ICON_DIR/32x32/apps/suano.png"
cp "$ICON_SRC/128.png" "$ICON_DIR/128x128/apps/suano.png"
cp "$ICON_SRC/256.png" "$ICON_DIR/256x256/apps/suano.png"
cp "$ICON_SRC/512.png" "$ICON_DIR/512x512/apps/suano.png"
...
# ── Done ──────────────────────────────────────────────────────────────
echo ""
echo "✅ Done! Suano installed to $BIN_DIR/$BINARY_NAME"
